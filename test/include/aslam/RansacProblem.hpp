#ifndef ASLAM_RANSAC_PROBLEM_HPP
#define ASLAM_RANSAC_PROBLEM_HPP
...
public:
    ...
    RansacProblem(bool randomSeed = true);
...
#include "implementation/RansacProblem.hpp"

#endif /* ASLAM_RANSAC_PROBLEM_HPP */
